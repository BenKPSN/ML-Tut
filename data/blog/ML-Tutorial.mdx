...
In terms of parameter tuning the most sensetive parameter is "solver".
...
In terms of parameter tuning the most sensetive parameters are "n_neighbors" and "weights".
...
- n\_ estimators (default: 100): the number of trees in the forest.
